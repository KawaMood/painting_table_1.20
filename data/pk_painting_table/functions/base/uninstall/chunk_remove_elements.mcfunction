#> pk_painting_table:base/uninstall/chunk_remove_elements
...
execute as @e[type=marker,tag=pk.pa_ta.painting_table.controller] at @s run function pk_painting_table:blocks/painting_table/remove/trigger
...
execute if score $uninstall.remaining_chunks pk.value matches 0 run schedule function pk_painting_table:base/uninstall/stop 1t
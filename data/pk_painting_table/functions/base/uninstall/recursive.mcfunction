#> pk_painting_table:base/uninstall/recursive
...
data modify block -30000000 62 1611 front_text.messages[0] set value '[{"text":"execute in "},{"nbt":"Uninstall.Array.Item.Dimension","storage":"pk.common:data"},{"text":" positioned "},{"nbt":"Uninstall.Array.Item.x","storage":"pk.common:data"},{"text":" "},{"nbt":"Uninstall.Array.Item.y","storage":"pk.common:data"},{"text":" "},{"nbt":"Uninstall.Array.Item.z","storage":"pk.common:data"},{"text":" run function pk_painting_table:base/uninstall/cb/3"}]'
...
# - CB 2
setblock -30000000 65 1611 chain_command_block[conditional=false,facing=up]{auto:1b,UpdateLastExecution:0b,Command:"function pk_painting_table:base/uninstall/cb/2"} replace
# - CB 3
...
execute unless data storage pk.common:data Uninstall.Array.Search[{}] run schedule function pk_painting_table:base/uninstall/stop 41t
execute if data storage pk.common:data Uninstall.Array.Search[{}] run schedule function pk_painting_table:base/uninstall/recursive 2t
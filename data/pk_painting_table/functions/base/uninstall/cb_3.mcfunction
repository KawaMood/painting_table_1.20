#> pk_painting_table:base/uninstall/cb_3
...
execute summon marker run function pk_painting_table:base/uninstall/marker_initialize

# Start process in the current chunk
function pk_painting_table:base/uninstall/chunk_check_state_recursive
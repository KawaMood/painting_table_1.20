...
data modify storage pk.common:data Uninstall.Elements append from storage pk.pa_ta:data Blocks.PaintingTables[]

# Create list of chunks
execute if data storage pk.common:data Uninstall.Elements[{}] run function pk_painting_table:base/uninstall/chunks_list_create_recursive
...
execute if score $uninstall.remaining_chunks pk.value matches 0 run function pk_painting_table:base/uninstall/stop
execute if score $uninstall.remaining_chunks pk.value matches 1.. run function pk_painting_table:base/uninstall/cbs_prepare_recursive
#> pk_painting_table:blocks/painting_table/remove/block_info/update_recursive
...
execute if data storage pk.common:data Temp.Array.Search[{}] run function pk_painting_table:blocks/painting_table/remove/block_info/update_recursive
#> pk_painting_table:blocks/painting_table/helpers/update/1_20_rotation/forceload_custom_blocks_chunks
...
execute summon marker run function pk_painting_table:blocks/painting_table/helpers/update/1_20_rotation/marker_initialize

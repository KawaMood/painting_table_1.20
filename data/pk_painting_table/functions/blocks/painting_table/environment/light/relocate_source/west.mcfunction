...
execute as @e[type=#pk_painting_table:custom_block/components,tag=pk.custom_block.decorative,tag=pk.temp.current,distance=..10] run function pk_painting_table:blocks/painting_table/environment/light/update_decorative_components/west
